...
class TeamStatsAggregated extends React.Component<any, { data: TeamGameStats[]; columns: MUIDataTableColumnDef[]; isLoading: boolean }> {
  side?: string;
  teamName?: string;
  map?: string;
...
export default withRouter(TeamStatsAggregated);
