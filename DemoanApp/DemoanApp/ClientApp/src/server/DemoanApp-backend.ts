...
export class FileClient {
    ...
    uploadDemo(file: FileParameter | null | undefined): Promise<void> {
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processUploadDemo(_response);
        });
    }

    protected processUploadDemo(response: Response): Promise<void> {
